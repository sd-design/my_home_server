...
func showfileManager(w http.ResponseWriter, r *http.Request) {

	Message := "List of files "
	data := PageData{
		PageTitle: "FILEmanager :: My home server – Cloaca v.1.0",
		Message:   Message,
	}

	files := []string{
		"./ui/html/filemanager.body.tmpl",
		"./ui/html/header.tmpl",
		"./ui/html/filemanager.footer.tmpl",
	}
